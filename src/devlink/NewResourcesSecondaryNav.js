...
import _styles from "./NewResourcesSecondaryNav.module.css";

export function NewResourcesSecondaryNav({ as: _Component = _Builtin.Block }) {
  return (
    <_Component className={_utils.cx(_styles, "nav-bar---secondary")} tag="div">
      ...
      >
        ...
        <_Builtin.Link
          className={_utils.cx(_styles, "nav-sec-link", "hide-mobile")}
          button={false}
