        ...
        <_Builtin.Grid className={_utils.cx(_styles, "grid-3")} tag="div">
          ...
          >
            <_Builtin.Image
              ...
              height="auto"
              alt="Value prop"
              src="https://cdn.prod.website-files.com/68d3fbd55d90bfdc11a99444/68d3fbd55d90bfdc11a99a6b_prediction-icon.webp"
            />
            <_Builtin.Heading
              className={_utils.cx(
                _styles,
          ...
          >
            <_Builtin.Image
              ...
              height="auto"
              alt="Value prop"
              src="https://cdn.prod.website-files.com/68d3fbd55d90bfdc11a99444/68d3fbd55d90bfdc11a99a6f_improvement-icon.webp"
            />
            <_Builtin.Heading
              className={_utils.cx(
                _styles,
          ...
          >
            <_Builtin.Image
              ...
              height="auto"
              alt="Value prop"
              src="https://cdn.prod.website-files.com/68d3fbd55d90bfdc11a99444/68d3fbd55d90bfdc11a99aee_security-icon.webp"
            />
            <_Builtin.Heading
              className={_utils.cx(
                _styles,
