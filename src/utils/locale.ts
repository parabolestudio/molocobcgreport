...
> = {
  English: {
    ...
    twitterImage: "/ai-disruption-index/og/twitter-image-en.jpg",
    imageAlt: "The AI Disruption Index by Moloco & BCG",
  },
  Japanese: {
    title: "AI ディスラプションインデックス",
    description: "Report by MolocoおよびBCG",
    ogImage: "/ai-disruption-index/og/opengraph-image-ja.jpg",
    twitterImage: "/ai-disruption-index/og/twitter-image-ja.jpg",
    imageAlt: "AI ディスラプションインデックス Moloco & BCG",
  },
  Korean: {
    title: "AI 시대, 변화하는 고객 여정과 새로운 기회",
    description: "리포트 Moloco 및 BCG",
    ogImage: "/ai-disruption-index/og/opengraph-image-ko.jpg",
    twitterImage: "/ai-disruption-index/og/twitter-image-ko.jpg",
    imageAlt: "AI 시대, 변화하는 고객 여정과 새로운 기회 Moloco & BCG",
  },
  Chinese: {
    title: "AI 颠覆指数报告",
    description: "联合发布 Moloco 和 BCG。",
    ogImage: "/ai-disruption-index/og/opengraph-image-zh.jpg",
    twitterImage: "/ai-disruption-index/og/twitter-image-zh.jpg",
