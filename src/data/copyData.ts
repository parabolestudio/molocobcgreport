...
export const copyData: CopyData = {
  ...
  "qu_expl_y_description": "<b>AI Disruption</b> <green>(y-axis)</green> scores disruption from high to low based on levels of:\n- Service Disruption: The ability for customers to use AI/LLM without having a direct relationship with a company\n- Discovery Disruption: Consumers going to LLMs for discovery rather than using traditional channels",
  "qu_expl_x_description": "<b>Customer Relationship Strength</b> <green>(x-axis)</green> scores strength from high to low based on reliance on paid user acquisition, ability to drive loyalty, and how much customers engage on platforms like apps (higher engagement) vs. the web (lower).",
